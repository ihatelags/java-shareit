...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getRequestsOfUser(long userId, int from, int size) {
    ...
    public ResponseEntity<Object> getExistingRequestsOfUsers(long userId, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "from", from,
                "size", size
        );
