...
class ItemRequestRepositoryTest {
    ...
    void findItemRequestsOfUserTest() {
        ...
        List<ItemRequest> itemsList =
                itemRequestRepository.findItemRequestByRequestorIdOrderByCreatedDesc(user.getId(), PageRequest.of(0,
                        10));
    ...
    void findItemRequestsOfAllUsersTest() {
        ...
        List<ItemRequest> itemsList =
                itemRequestRepository.findItemRequestByRequestorIdNotOrderByCreatedDesc(userNew.getId(),
                        PageRequest.of(0, 10));
